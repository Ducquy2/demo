...
class Model_mathang extends CI_Model {
...
$this->db->limit($limit, $offset);
$this->db->order_by($order_by);
$this->db->where('soluongton >', 0);
$query=$this->db->get($view);
return $query;


}
//function get_with_limit_where($id,$limit, $offset, $order_by) {
//$table = $this->get_table();
//$this->db->limit($limit, $offset);
//$this->db->order_by($order_by);
//$this->db->where('loaihang_id', $id);
//$query=$this->db->get($table);
//return $query;
//
//
...
$table = $this->get_table();
$this->db->where('id_mathang', $id);
$query=$this->db->get($table);
return $query;

}
function get_where_mh($id) {
$view = $this->get_view();
$this->db->where('soluongton', $id);
$query=$this->db->get($view);
return $query;
...
function get_where_custom_like($col, $value) {
$table = $this->get_table();
//$this->db->where($col, $value);
//
//$this->db->where_in($value,$col);
