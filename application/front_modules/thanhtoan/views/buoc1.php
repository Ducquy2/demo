...
<form method="post"> 
        <div class="row">
          ...
          <a class="btn btn-primary" href="<?php echo base_url()."giohang" ?>">Giỏ Hàng</a>
        </div>
...
<form class="cd-form floating" method="post">
        <fieldset>
            ...
            <div class="error-message">
                <p>Xin Qúy Khách Vui Lòng nhập thông tin để nhân viên có thể giao hàng đến tận tay quý khách</p>
            </div>
            ...
            <div class="form-group required">
                ...
                <input class="user" type="text" name="TENKH" id="cd-name" required="">
            ...
            <div class="form-group required">
                ...
                <input class="company" type="number" name="sdtkh" id="cd-company">
               
            </div> 
 
           <div class="form-group required">
               <div class="col-md-4">
                <label class="col-md-4 control-label" for="cd-email">Email</label>
                 </div>
                <input class="email error" type="email" name="emailkh" id="cd-email" required="">
            ...
            <div class="form-group required">
                ...
                <input class="user" type="text" name="diachikh" id="cd-name" required="">
