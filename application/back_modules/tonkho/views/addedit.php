...
<?php echo Modules::run('menu2'); ?>
 ...
 <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Sửa Tồn Kho
                        </h1>
                    </div>
                    <!-- /.col-lg-12 -->
                    <div class="col-lg-7" style="padding-bottom:120px">
                        <form action="" method="POST">
                                ...
                                <select class="form-control" name="mathang_id">
                                    <?php
                                        ...
                                        foreach($data[2] as $k=>$v){
                                           if($tt==1){
                                            ?>
                                    <option  <?php echo $data[0]->mathang_id==$v->mathang_id ?> value="<?php echo $v->mathang_id ?>" selected=""><?php echo $v->tenmh ?></option>
                                        <?php
                                            }
                                        else {
                                            ?>
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" name="soluongton" value="
                                        <?php
                                            if($tt==1)
                                            {
                                               echo $data[0]->soluongton;
                                            }
                                         ?>
                            ...
                            <div class="form-group">
                                <label>Đơn Giá BQ</label>
                                <input class="form-control" name="dongiabq" value="
                                        <?php
                                            if($tt==1)
                                            {
                                               echo $data[0]->dongiabq;
                                            }
                                         ?>
...
<!-- Ket Thuc Truy van khoa ngoai va xuat hien ten cuar chung--> 
 ...
 <p><b style="color: blue;">Chọn hình để up </b></P> <br>
     ...
     <!--Khai bao editor   -->
   <div> <textarea name="ghichu" id="editor1" rows="10" cols="100">
             <?php
                if($tt==1)
                {
                   echo $data[0]->ghichu;
