...
$.fn.storeLocator = function(options) {
  ...
  var settings = $.extend( {
      'mapDiv': 'map',
      'listDiv': listdov,
      'listDivFull':'loc-list-full',
      'numStoreToClick': numStorelistToClick,
      'idStoreToClick': sStorelistToClick,
      'storedetail': 'store-selected-detail',
      'formContainerDiv': 'form-container',
      'mapContainerDiv':map_container,
      ...
      'infowindowTemplatePath': 'http://anphuoc.com.vn/templates/infowindow-description.html',
      'listTemplatePath': 'http://anphuoc.com.vn/templates/location-list-description.html',
      'listStoreDiscriptionFull': 'http://anphuoc.com.vn/templates/location-list-description-full.html',
      'KMLinfowindowTemplatePath': 'http://anphuoc.com.vn/templates/kml-infowindow-description.html',
      'KMLlistTemplatePath': 'http://anphuoc.com.vn/templates/kml-location-list-description.html',
  ...
  var $this = $(this);
  var listTemplate,listTemplateFull, infowindowTemplate;
  ...
  */
 /* Load template for div with full description */
 function load_templates_full()
  {
    if(settings.dataType === 'kml')
    {
      //KML infowindows
      ...
      $.get(settings.KMLlistTemplatePath, function(template) {
          var source = template;
          listTemplateFull = Handlebars.compile(source);
      ...
      //Locations list
      $.get(settings.listStoreDiscriptionFull , function(template) {
          var source = template;
          listTemplateFull = Handlebars.compile(source);
...
function locator()
{
  	...
  	function reset()
  	{
    	...
    	$(document).off('click.'+prefix, '#' + settings.listDivFull + ' li');
  	}
  ...
  $(function(){
        ...
        if(settings.dataType === 'kml'){
          ...
          dataTypeRead = settings.dataType;
			...
			data = $.parseXML( settings.dataContent );
            ...
            //Process XML
             ...
             /*   'city': $(this).attr('city'),
                  ...
                  'hours4': $(this).attr('hours4'),
                  'hours5': $(this).attr('hours5'),
                  'hours6': $(this).attr('hours6'),
                  'hours7': $(this).attr('hours7'),
          ...
          $(function(){ 
             ...
             var key, value, locationData = {};
              ...
              function define_location_data(currentMarker){
                ...
                */
               var indicator = settings.storeLetterDef;
              ...
              if(settings.originMarker === true && settings.fullMapStart === false){
                ...
                var marker = new google.maps.Marker({
                    ...
                    icon: 'http://anphuoc.com.vn/images/logo_2.gif',
                    draggable: false
                  });
              }
              ...
              for(var y = 0; y <= storenum; y++) { 
                ...
                var letter = settings.storeLetterDef;
              ...
              function listClick(marker){
                ...
                var listHtmlFull = listTemplateFull(locations);
                //$('#' + settings.listDiv + ' ul').append(listHtml);
                $('#' + settings.listDivFull + ' ul').append(listHtmlFull);
              }

              //Handle clicks from the list
              for (var stc =0;stc<settings.numStoreToClick;stc++){
              $(document).on('click.'+prefix, '#'+settings.idStoreToClick+stc, function(){
              	/*scro;; to map possition */
              	$('html, body').animate({scrollTop: $("#"+settings.mapContainerDiv).offset().top}, 500);
                ...
                /*Set content to specified element*/
                $('#'+settings.storedetail).html($('#' + settings.listDivFull + ' li[data-markerid=' + markerId +']').html());
                map.setZoom(settings.zoomStoreLevel);
